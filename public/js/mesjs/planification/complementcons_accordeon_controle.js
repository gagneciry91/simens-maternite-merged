...
var theHREF = tabUrl[0] + "public/planification/planification";
...
$("#annuler2").click(function(){
    ...
    vart = tabUrl[0]+'public/planification/planification';
	vart=tabUrl[0]+'public/planification/complement-planification?id_patient='+idPatient+'&id_cons='+id_cons;
...
//alert( donnees['bilan_inflammatoire']);
    ...
    for (var i = 1; i < 10; i++) {
        if ($("#Visite_0" + i).val()) {
            donnees['Visite_0' + i] = $("#Visite_0" + i).val();
            donnees['date_' + i] = $("#date_" + i).val();
            donnees['dateDernierRegle_' + i] = $("#dateDernierRegle_" + i).val();
            donnees['poids_' + i] = $("#poids_" + i).val();
            donnees['ta_' + i] = $("#ta_" + i).val();
            donnees['observation_' + i] = $("#observation_" + i).val();
            donnees['unites_' + i] = $("#unites_" + i).val();
            donnees['dateProchain_' + i] = $("#dateProchain_" + i).val();
...
getplanification($('#type_accouchement').val());
function fAddText() { 
