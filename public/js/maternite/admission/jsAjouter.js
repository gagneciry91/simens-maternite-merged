...
function visualiser(id){
	 confirmation(id);
	 var cle = id;
    var chemin = tabUrl[0]+'public/admission/declarer-deces';
    $.ajax({
        type: 'POST',
        url: chemin ,
        data:'id='+cle,
...
function initialisation(){
	...
	( {
		...
		"sAjaxSource": ""+tabUrl[0]+"public/admission/liste-admission-ajax", 
...
function declarer(id){
    ...
    var cle = id;
    var chemin = tabUrl[0]+'public/admission/admission';
    $.ajax({
        type: 'POST',
        url: chemin ,
        data: $(this).serialize(),  
    ...
    $("#annuler").click(function(){
	    ...
	    vart = tabUrl[0]+'public/admission/admission';
