function creerLalisteVisite ($listeDesElements) {
    	var index = $("Visites").length; 
			        $liste = "<div id='Visites_"+(index+1)+"'>"+
				             "<Visites>"+
				             "<table class='table table-bordered' id='DateRegle' style='margin-bottom: 0px; width: 100%;'>"+
                             "<tr style='width: 100%;'>" +
                             ...
                             "<th id='poids_"+(index+1)+"'  style='width: 59%;'  >"+
